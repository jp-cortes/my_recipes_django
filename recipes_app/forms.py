...
class RecipeForm(forms.Form):
    name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"placeholder": "Pizza Margarita", "class": "w-full rounded-lg p-2"}
        ),
    )
    ...
    ingredients = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "placeholder": "100gr white cheese, 2 eggs, ...",
    ...
    category = forms.CharField(
        ...
        label="category",
        widget=forms.TextInput(
            attrs={"placeholder": "Vegetarian", "class": "w-full rounded-lg p-2"}
        ),
    )
